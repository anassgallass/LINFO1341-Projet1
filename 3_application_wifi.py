...
files = [
    "wireshark/0_wifi_before.pcapng",
    "wireshark/1_wifi_connexion.pcapng",
    "wireshark/2_wifi_folder.pcapng",
    "wireshark/3a_wifi_upload_word.pcapng",
    "wireshark/3b_wifi_upload_video.pcapng",
    "wireshark/4a_wifi_visu_word.pcapng",
    "wireshark/4b_wifi_visu_video.pcapng",
    "wireshark/5a_wifi_download_word.pcapng",
    "wireshark/5b_wifi_download_video.pcapng",
    "wireshark/6_wifi_delete_video.pcapng",
    "wireshark/7_wifi_share_word.pcapng",
    "wireshark/8_wifi_modif_shared_word.pcapng",
    "wireshark/9_wifi_deconnexion.pcapng"
]
